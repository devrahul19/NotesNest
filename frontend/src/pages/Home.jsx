    ...
    <div className="snap-y snap-mandatory h-screen overflow-y-scroll relative">
      ...
      <section id="section-0" className="snap-start h-screen flex items-center relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          {/* Gradient overlay */}
          <div className="absolute inset-0 bg-gradient-to-r from-blue-600/50 via-indigo-600/50 to-blue-600/50 animate-gradient-shift"></div>
          
          {/* Animated patterns */}
          <div className="absolute inset-0">
            {/* Moving dots */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,white_1px,transparent_0)] bg-[size:40px_40px] animate-slide-up opacity-20"></div>
            
            {/* Floating orbs */}
            <div className="absolute inset-0">
              <div className="absolute h-32 w-32 rounded-full bg-blue-400/30 blur-xl animate-float" 
                   style={{top: '20%', left: '15%', animationDelay: '-2s'}}></div>
              <div className="absolute h-48 w-48 rounded-full bg-indigo-400/30 blur-xl animate-float" 
                   style={{top: '60%', left: '80%', animationDelay: '-4s'}}></div>
              <div className="absolute h-40 w-40 rounded-full bg-violet-400/30 blur-xl animate-float" 
                   style={{top: '40%', left: '60%', animationDelay: '-6s'}}></div>
            </div>
            
            {/* Light beams */}
            <div className="absolute inset-0 opacity-30">
              <div className="absolute inset-0 rotate-45 bg-gradient-to-r from-transparent via-white/5 to-transparent animate-beam"></div>
              <div className="absolute inset-0 -rotate-45 bg-gradient-to-r from-transparent via-white/5 to-transparent animate-beam" 
